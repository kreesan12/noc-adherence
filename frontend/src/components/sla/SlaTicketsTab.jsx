...
export default function SlaTicketsTab({
  ...
  return (
    <Stack spacing={1.5}>
      <Paper elevation={0} sx={{ p: 1.25, border: '1px solid #e5e7eb', borderRadius: 3.25, boxShadow: '0 12px 28px rgba(15, 23, 42, 0.05)', background: 'linear-gradient(180deg, #f7faff 0%, #ffffff 100%)' }}>
        <Stack spacing={1.1}>
          <Box>
